...
public class DomainPageFragment extends Fragment {
    ...
    public static DomainPageFragment newInstance(int page) {
        Bundle args = new Bundle();
        args.putInt(ARG_PAGE, page);
        DomainPageFragment fragment = page == LIST_PAGE ? new ProviderListPageFragment(): new DomainPageFragment();
